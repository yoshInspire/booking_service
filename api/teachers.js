...
export default async function handler(req, res) {
    ...
    if (req.method === 'GET') {
        const teachers = [
            ...
            {"name": "Кизерова В. С.", "room": "1017"},
            {"name": "Колодчевская Е. А.", "room": "3013"},
            {"name": "Копылова П. И.", "room": "2007"},
            {"name": "Кондрашова З. В.", "room": "5061"},
            ...
            {"name": "Макушина А. В.", "room": "2010"},
            {"name": "Малышева О. Д.", "room": "3036"},
            {"name": "Малышева Т. В.", "room": "3006"},
            {"name": "Марарова М. С.", "room": "1011а"},
